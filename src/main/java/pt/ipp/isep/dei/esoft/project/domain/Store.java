...
public class Store {
    ...
    public Store(String designation, String location, int phoneNumber, String emailAddress, int ID) {
    ...
    public boolean equals(Object o) {
        ...
        Store store = (Store) o;
        return phoneNumber == store.phoneNumber && ID == store.ID && Objects.equals(designation, store.designation) && Objects.equals(location, store.location) && Objects.equals(emailAddress, store.emailAddress);
    }

    @Override
    public int hashCode() {
        return Objects.hash(designation, location, phoneNumber, emailAddress, ID);
    }
