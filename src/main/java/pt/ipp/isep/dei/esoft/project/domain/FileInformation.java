...
public class FileInformation {
    ...
    private Agent ownerInstance;
    private Store storeInstance;
    private Announcement announcementInstance;
     ...
     */
  /**  public void loadInformationFromFile(String path, AnnouncementRepository advertisementRepository,
                                        ...
                                        AgentRepository personRepository) {
               ...
               // saveOwnerInformation(new Email(ownerEmail), ownerName, ownerPassportNumber, ownerTaxNumber,
                ...
                if (propertyType.equalsIgnoreCase("Land")) {
                    saveLandInformation(propertyArea, propertyDistanceFormCity, propertyStreet, propertyCity,
                            ...
                            cityRepository, districtRepository, stateRepository, announcementRepository);
                    ...
                    saveApartmentInformation(propertyArea, propertyDistanceFormCity, propertyStreet, propertyCity,
                            ...
                            airConditioning, cityRepository, districtRepository, stateRepository, announcementRepository);
   ...
   /** private void saveHouseInformation(double propertyArea, double propertyDistanceFormCity, String propertyStreet,
                                      ...
                                      AnnouncementRepository advertisementRepository) {
        announcementInstance = advertisementRepository.createHouseAnnouncement(ownerInstance, propertyArea, propertyDistanceFormCity,
        ...
        announcementRepository.addAnnouncement(announcementInstance);
    }
   ...
   /** private State createState(String state, StateRepository stateRepository) {
     ...
     * @param agentRepository person repository
     */
   /** private void saveOwnerInformation(Email email, String ownerName, String ownerPassportNumber, String ownerTaxNumber,
                                      String ownerPhone, AgentRepository agentRepository) {
        ownerInstance = agentRepository.createAgent(email, ownerName, ownerPassportNumber, ownerTaxNumber, ownerPhone);
        agentRepository.registerClient(ownerInstance);
    }
