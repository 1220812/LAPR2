...
public class PropertyAddress {
     ...
     * @param city city
     */
    public PropertyAddress(String streetAddress, int doorNumber, int floorNumber, String zipCode, State state, District district, City city) {
    ...
    public PropertyAddress(String streetAddress, String zipCode, State state, District district, City city) {
        if (StringUtils.isBlank(streetAddress) || StringUtils.isBlank(zipCode) || state == null || district == null || city == null) {
            throw new IllegalArgumentException("Invalid arguments.");
        }
        if (zipCode.length() != ZIP_CODE_LENGTH || !StringUtils.isNumeric(zipCode)) {
    ...
    public boolean equals(Object o) {
        ...
        PropertyAddress propertyAddress = (PropertyAddress) o;
        return Objects.equals(getStreetAddress(), propertyAddress.getStreetAddress()) &&
                Objects.equals(getDoorNumber(), propertyAddress.getDoorNumber()) &&
                Objects.equals(getFloorNumber(), propertyAddress.getFloorNumber()) &&
                Objects.equals(getZipCode(), propertyAddress.getZipCode()) &&
                Objects.equals(getState(), propertyAddress.getState());
    }
    @Override
    public int hashCode() {
     ...
     */
    public PropertyAddress clone(){ return new PropertyAddress(this.streetAddress, this.doorNumber,this.floorNumber,this.zipCode,this.state,this.district,this.city); }
}